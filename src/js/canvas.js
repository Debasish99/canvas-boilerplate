...
function init(){
         ...
         platforms = [new Platform({x:-1,y:470 , image:platformimage}) 
            ...
            ,new Platform({x:platformimage.width*4 + 320,y:230,image: platformSmallTallImage})
            ,new Platform({x:platformimage.width*5 + 500,y:470,image:platformimage})
            ,new Platform({x:platformimage.width*6 + 220,y:270,image:platformimage})
            ,new Platform({x:platformimage.width*7 + 520,y:170,image:platformimage})
            ,new Platform({x:platformimage.width*8 + 820,y:220,image:platformimage})
